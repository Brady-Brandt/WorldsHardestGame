        ...
        for side in sides:
            if side == 1:
                ...
                self.left_border = Border(
                    Dim(x - border_width, y - border_width, border_width, h + border_width))
            elif side == 2:
                # top border
                self.top_border = Border(
                    Dim(x - border_width, y - border_width, w + border_width, border_width))
            elif side == 3:
                # right border
                self.right_border = Border(
                    Dim(w + x, y - border_width, border_width, h + border_width * 2))
            elif side == 4:
                # bottom border
                self.bottom_border = Border(
                    Dim(x - border_width, y + h, w + border_width, border_width))
...
class Coin:
    ...
    def __init__(self, location):
        self.location = (location[0], location[1], Coin.width, Coin.width)
